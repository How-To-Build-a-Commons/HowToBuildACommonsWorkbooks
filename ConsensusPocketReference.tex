...
\begin{document}
	...
	\AddToShipoutPictureBG*{%
		\AtPageLowerLeft{%
			\includegraphics[width=\paperwidth,height=\dimexpr\paperheight\relax]{src/how-to-consensus-zine/mucha.png}
		}%
	}
...
\begin{center}
	...
	{\Huge\textbf{Intro to}}\\[0.2cm]
	{\Huge\textbf{Achieving}}\\[0.2cm]
	{\Huge\textbf{Consensus}}\\[0.5cm]
	
	{\Large Consensus Decision Making (CDM)}\\[0.1cm]
	{\Large Intro and Reference}\\[0.75cm]
